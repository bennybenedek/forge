...
/**
 * Visual representation of a Chest node in the Rogue Commander path. Chests provide rewards without
 * combat. Displays as a small circular node with a chest icon.
 */
