...
/**
 * Assembles Swing components for Rogue Commander statistics screen. Shows player's meta progression
...
public enum VSubmenuRogueStats implements IVSubmenu<CSubmenuRogueStats> {
  ...
  // Run statistics
  private final FLabel lblRunsStarted = new FLabel.Builder().text("Runs Started: 0").fontSize(14)
      .build();
  private final FLabel lblRunsCompleted = new FLabel.Builder().text("Runs Completed: 0")
      .fontSize(14).build();
  ...
  // Match statistics
  private final FLabel lblMatchesWon = new FLabel.Builder().text("Matches Won: 0").fontSize(14)
      .build();
  private final FLabel lblMatchesLost = new FLabel.Builder().text("Matches Lost: 0").fontSize(14)
      .build();

  // Milestones
  private final FLabel lblMaxLife = new FLabel.Builder().text("Max Life Reached: 0").fontSize(14)
      .build();
  private final FLabel lblMaxGold = new FLabel.Builder().text("Max Gold Earned: 0").fontSize(14)
      .build();
