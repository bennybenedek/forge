...
public enum AetherUpgrade {
    LEVEL_1(1, "Aether Upgrade 1", "Gain +1 active Boon slot.", 1, 20, 1, 0),
    LEVEL_2(2, "Aether Upgrade 2", "Unlock new Boons in the Aether.", 2, 30,  0, 0),
    LEVEL_3(3, "Aether Upgrade 3", "Boons gain +1 maximum rank.", 3, 40,  0, 1),
    LEVEL_4(4, "Aether Upgrade 4", "Gain +1 active Boon slot.", 4, 50, 1, 0);
    ...
    AetherUpgrade(int level, String name, String description, int sparkCost,
                  int echoCost, int extraBoonSlots, int extraBoonRanks) {
        this.level = level;
        this.name = name;
