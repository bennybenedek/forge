...
public class ForgePreferences extends AbstractPreferences<ForgePreferences.FPref> {
    ...
    public enum FPref implements AbstractPreferences.IPref {
        ...
        UI_SHOW_ACTIONABLE_HIGHLIGHTS ("true"),
        UI_SHOW_AUTOTAP_PREVIEW ("true"),
        ...
        YIELD_AUTO_PASS_NO_ACTIONS ("true"),
        YIELD_AUTO_PASS_RESPECTS_INTERRUPTS ("true"),
        YIELD_AVAILABLE_ACTIONS_BUDGET_MS ("1500"),
        YIELD_SKIP_PHASE_DELAY ("false"),
        YIELD_SKIP_RESOLVE_DELAY ("false"),
        YIELD_SUPPRESS_ON_OWN_TURN ("true"),
        YIELD_SUPPRESS_AFTER_END ("false"),
        YIELD_DECLINE_SCOPE_STACK_YIELD ("ALWAYS"),
        YIELD_DECLINE_SCOPE_NO_ACTIONS ("ALWAYS"),
